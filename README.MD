...
[**GroupGets**](https://groupgets.com/campaigns/329-diy-thermocam-round-5) does now offer a **complete self-assembly kit**, so you **don't have to worry** about buying **all the parts on your own**. 
...
<a href="https://groupgets.com/campaigns/329-diy-thermocam-round-5"><img src="https://github.com/maxritter/DIY-Thermocam/blob/master/Images/Website/GroupGetsLogo.jpg?raw=true"></a>
...
- Buy the **[self-assembly kit](https://groupgets.com/campaigns/329-diy-thermocam-round-5)** from **GroupGets**. It includes **all required parts** except for the **Lepton sensor** and **module**. After you click on **"Join this buy"**, you can add the **Lepton module** and the **Lepton3.0** or **Lepton2.5** sensor to your order.
